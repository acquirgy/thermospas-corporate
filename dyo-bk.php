...
<A href=\"/index.php?option=com_content&view=article&id=235&Itemid=414&tub=".$tub."&jets=".$jets."&fname=".$fname."&lname=".$lname."&email=".$email."&zip=".$zip."&city=".$city."\"><h2>Video and Brochure</h2></A></div>\n
