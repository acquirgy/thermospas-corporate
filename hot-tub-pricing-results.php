...
Container Tag ID: 1204*/
		...
		echo '<iframe height="1" width="1" frameborder="0" scrolling="no" src=https://www.emjcd.com/tags/c?containerTagId=1204&ITEM1=lead&AMT1=1&QTY1=1&CID=1524481&OID='.$_REQUEST['ht_id'].'&TYPE=354381&CURRENCY=USD name="cj_conversion" ></iframe>';
...
//window.location = "<? echo "http://www.thermospas.com/thermospas-dvd.html?callid=$callid&call_time=".$_REQUEST['call_time']."&call_day=".$call_day.""; ?>"
...
<div style="margin:10px 0px;">
  ...
  <? if (strlen($_REQUEST['fq']) > 1) { } else { ?><h6 style="margin:5px 0px; padding:0px"><span style="font-style: italic">We are processing your pricing request, please see below </span></h6><? } ?>
	...
	<div id="fullwidth_footer_bottom">
		...
		<div class="container_12">
			...
			<div class="grid_8 copyright">
				...
				<p class="rights">Copyright 2011 by <a href="landing/index.html" title="ThermoSpas">ThermoSpas</a>. All rights reserved. <a href="http://www.thermospas.com/thermospas_privacy_policy.html" target="_new">thermospas privacy policy</a></p>
...
<!-- --------------------------------------------------------------------------CONFIRMATION PAGE CODEBe sure to replace all the variables indicated with @VARIABLE@ with real data.-------------------------------------------------------------------------- --><!-- BEGIN: Marin Software Tracking Script (Confirmation Page) --><script type='text/javascript'>var _mTrack = _mTrack || [];_mTrack.push(['addTrans', {    currency :'USD',    items : [{        convType : 'lead'    }]}]);_mTrack.push(['processOrders']);(function() {    var mClientId = '4340yn26624';    var mProto = (('https:' == document.location.protocol) ? 'https://' : 'http://');    var mHost = 'tracker.marinsm.com';    var mt = document.createElement('script'); mt.type = 'text/javascript'; mt.async = true; mt.src = mProto + mHost + '/tracker/async/' + mClientId + '.js';    var fscr = document.getElementsByTagName('script')[0]; fscr.parentNode.insertBefore(mt, fscr);})();</script><noscript><img width="1" height="1" src="https://tracker.marinsm.com/tp?act=2&cid=4340yn26624&script=no" /></noscript><!-- END: Copyright Marin Software --></body>
