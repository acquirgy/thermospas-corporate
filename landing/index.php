...
<body id="top">
	...
	<div id="main_content" class="container_12">
		...
		image: "/dev/slides/aquatic_video.jpg"
		...
		<div class="grid_6 feat margin-1">
			...
			<a id="example6" href="/dev/slides/lounge.jpg" title="ThermoSpas Wave Lounges - Available in many of our hot tubs"><img alt="example6" src="/dev/wp-content/themes/majestics/timthumb.php?src=/dev/slides/lounge.jpg&h=134&w=138" /></a>

			<a id="example6" href="/dev/slides/lighting.jpg" title="ThermoSpas Elegant Lighting Effects and Sound Systems"><img alt="ThermoSpas Elegant Lighting Effects and Sound Systems" src="/dev/wp-content/themes/majestics/timthumb.php?src=/dev/slides/lighting.jpg&h=134&w=138" /></a>

			<a id="example6" href="/dev/slides/bubbling-video.jpg" title="Everyone loves the ThermoSpas Bubbling System"><img alt="example6" src="/dev/wp-content/themes/majestics/timthumb.php?src=/dev/slides/bubbling-video.jpg&h=134&w=138" /></a>

			<a id="example6" href="/dev/slides/filtration-video.jpg" title="ThermoSpas Filtration System filters the water over 100x more then our competitors"><img alt="example6" src="/dev/wp-content/themes/majestics/timthumb.php?src=/dev/slides/filtration-video.jpg&h=134&w=138" /></a>

			<a id="example6" href="/dev/slides/siteinspection.jpg" title="Request a Free Site Inspection to help measure and plan out your hot tub."><img alt="example6" src="/dev/wp-content/themes/majestics/timthumb.php?src=/dev/slides/siteinspection.jpg&h=134&w=138" /></a>

			<a id="example6" href="/dev/slides/jets-video.jpg" title="Thermospas allows you to choose from 10 to 160 jets"><img alt="example6" src="/dev/wp-content/themes/majestics/timthumb.php?src=/dev/slides/jets-video.jpg&h=134&w=138" /></a>
