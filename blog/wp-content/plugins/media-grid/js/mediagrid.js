(function($) {
	...
	// size boxes
	mg_size_boxes = function(cont_id) {
	...
	// open item trigger
	jQuery('body').delegate('.mg_closed', 'click', function(){
	...
	jQuery('body').delegate('#mg_nav .mg_nav_next, #mg_nav .mg_nav_prev', 'hover', function(){
	...
	// switch item
	jQuery('body').delegate('.mg_nav_prev, .mg_nav_next', 'click', function(){
	...
	jQuery(document).delegate('#mg_close, #mg_full_overlay_wrap.mg_classic_lb', 'click', function(){
		mg_close_lightbox();
	});
