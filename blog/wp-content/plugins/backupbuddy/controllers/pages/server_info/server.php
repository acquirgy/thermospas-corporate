...
if ( isset( $_GET['phpinfo'] ) && $_GET['phpinfo'] == 'true' ) {
	...
	echo '<br>';
	echo '<center>';
	echo '<a href="#TB_inline?width=640&#038;height=600&#038;inlineId=pb_backupbuddy_serverinfo_results" class="button button-secondary thickbox" title="Server Information Results">Display Results in Text Format</a> &nbsp;&nbsp;&nbsp; ';
	if ( !defined( 'PB_IMPORTBUDDY' ) ) {
...
<div id="pb_backupbuddy_serverinfo_results" style="display: none;">
<h3>Server Information Results</h3>
<textarea style="width: 100%; height: 300px;" wrap="off"><?php
