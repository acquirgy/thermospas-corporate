...
echo '<div style="margin-top: 40px;">';
	...
	pb_backupbuddy::$ui->start_tab( 'overview' );
		...
		*/
		...
		<br><br>
		<span class="pb_label pb_label">512MB Free Storage</span> Active BackupBuddy customers already have a <b>BackupBuddy Stash</b> account. Just login on the <a href="?page=pb_backupbuddy_destinations">Remote Destinations</a> page.
		<br>
	...
	pb_backupbuddy::$ui->start_tab( 'restore_migrate' );
		...
		You may <b>restore sites to the same server</b> or <b>migrate to a new server / URL</b>.
		...
		<ol>
			<li>
				Upload the <b>backup ZIP file</b> and <b>importbuddy.php tool</b> (download on the <a href="<?php echo $migrate_page_url; ?>">Migrate, Restore</a> page)
