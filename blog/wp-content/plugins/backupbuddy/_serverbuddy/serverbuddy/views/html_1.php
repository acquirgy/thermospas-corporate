	...
	function pb_advanced_options() {
		...
		<div style="margin-left: 15px; font-size: 16px;">
			...
			<div id="toggle-advanced" class="toggled" style="margin-top: 12px;">
				...
				" /> Wipe database tables that match new prefix on import. <span class="pb_label pb_label-warning">Caution</span> <?php pb_backupbuddy::tip( 'WARNING: Checking this box will have this script clear ALL existing data from your database that match the new database prefix prior to import, possibly including non-WordPress data. This is useful if you are restoring over an existing site or repairing a failed migration. Use caution when using this option and double check the destination prefix. Use with caution. This cannot be undone.' ); ?><br>
				...
				<input type="checkbox" value="on" name="skip_database_migration"> Skip all migration of URLs/paths in database. <br>
				...
				Error Logging to importbuddy.txt: <select name="log_level">
					...
					<option value="1">Errors Only (default)</option>
					<option value="2">Errors & Warnings</option>
					<option value="3" selected>Everything (debug mode)</option>
