...
<!--<![endif]-->
	<head>
		...
		if ( pb_backupbuddy::$options['skip_database_migration'] != false ) {
			echo '<img src="' . pb_backupbuddy::plugin_url() . '/images/bullet_error.png" style="vertical-align: -3px;">';
			echo 'Debug option to skip database migration (import only) set to true. The database will not be migrated.<br>';
		}
		if ( pb_backupbuddy::$options['skip_database_bruteforce'] != false ) {
			echo '<img src="' . pb_backupbuddy::plugin_url() . '/images/bullet_error.png" style="vertical-align: -3px;">';
			echo 'Debug option to skip database brute force migration (basic migration only) set to true. The database will not be brute force migrated.<br>';
		}
