...
if ( !class_exists( "pluginbuddy_zipbuddy" ) ) {
	...
	class pluginbuddy_zipbuddy {
		...
		const ZIP_METHODS_TRANSIENT_EXPERIMENTAL = 'pluginbuddy_backupbuddy_avail_xzip_methods';
		const ZIP_METHODS_TRANSIENT_LIFE = 3600;
		 ...
		 *
		 */
		public function add_directory_to_zip( $zip_file, $add_directory, $compression, $excludes = array(), $temporary_zip_directory = '', $force_compatibility_mode = false ) {
			if ( true === $this->_is_experimental ) {
