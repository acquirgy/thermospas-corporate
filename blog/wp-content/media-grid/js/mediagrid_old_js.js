(function($) {
	...
	jQuery('#mg_nav .mg_nav_next, #mg_nav .mg_nav_prev').unbind('hover');
	...
	jQuery('#mg_close, #mg_full_overlay_wrap.mg_classic_lb').live('click', function(){
		mg_close_lightbox();
	});
	...
	jQuery('.mg_filter a').live('click', function(e) {
		e.preventDefault();
