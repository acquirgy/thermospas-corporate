...
(function($, undefined) {
	...
	jPlayerPlaylist.prototype = {
		...
		_createItemHandlers: function() {
			...
			$(this.cssSelector.playlist + " a." + this.options.playlistOptions.itemClass).unbind("click");
			$('body').delegate(this.cssSelector.playlist + " a." + this.options.playlistOptions.itemClass, "click", function() {
			...
			$(self.cssSelector.playlist + " a." + this.options.playlistOptions.freeItemClass).unbind("click");
			$('body').delegate(self.cssSelector.playlist + " a." + this.options.playlistOptions.freeItemClass, "click", function() {
			...
			$(self.cssSelector.playlist + " a." + this.options.playlistOptions.removeItemClass).unbind("click");
			$('body').delegate(self.cssSelector.playlist + " a." + this.options.playlistOptions.removeItemClass, "click", function() {
				var index = $(this).parent().parent().index();
				self.remove(index);
				$(this).blur();
				return false;
