...
if ($_REQUEST['call_day'] == 'choose' || $_REQUEST['call_time'] == 'choose') {
	...
	header ("Location: http://www.thermospas.com/pricing-information.html?tub=".$_REQUEST['tub']."&fname=".$_REQUEST['fname']."&lname=".$_REQUEST['lname']."&phone=".$_REQUEST['phone']."&email=".$_REQUEST['email']."&jets=".$_REQUEST['jets']."&tub=".$_REQUEST['tub']."&lead_id=".$_REQUEST['lead_id']."&call=err#call");
	...
	$result = mysql_query("UPDATE leads set call_date = '".$call_date."', call_day = '".$call_day."', call_time = '".$_REQUEST['call_time']."', create_date = '".$lead_date."' WHERE id = '".$myleadid."'");
	
	/*$result = mysql_query("INSERT INTO lead_calls (`id`, `name`, `first_name`, `last_name`, `phone`, `email`, `tub`, `jets`,`call_date`,`call_day`, `call_time`, `date_added`) VALUES 
	('".$_REQUEST['lead_id']."','".$_REQUEST['name']."','".$_REQUEST['fname']."', '".$_REQUEST['lname']."', '".$_REQUEST['phone']."', '".$_REQUEST['email']."', 
...
if (strlen($address1)>3 && strlen($zip)>3) { 
...
echo '<div style="height:1px; overflow:hidden;">';
...
echo '<!-- Google Code for MAIN PPC Lead Conversion Page -->
...
var google_conversion_label = "yoU1CIjkywEQgJe2_gM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1070435200/?label=yoU1CIjkywEQgJe2_gM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
';
	...
	echo "<!-- Google Code for TS Lead Conversion Page -->
<script type=\"text/javascript\">
<!--
var google_conversion_id = 1072578670;
var google_conversion_language = \"en\";
var google_conversion_format = \"3\";
var google_conversion_color = \"ffffff\";
var google_conversion_label = \"ULwYCLXgtwEQ7oC5_wM\";
var google_conversion_value = 0;
//-->
</script>
<script type=\"text/javascript\" src=\"http://www.googleadservices.com/pagead/conversion.js\">
...
<noscript>
<div style=\"display:inline;\">
<img height=\"1\" width=\"1\" style=\"border-style:none;\" alt=\"\" src=\"http://www.googleadservices.com/pagead/conversion/1072578670/?label=ULwYCLXgtwEQ7oC5_wM&amp;guid=ON&amp;script=0\"/>
</div>
</noscript>";


echo "<!-- Google Website Optimizer Conversion Script -->
<script type=\"text/javascript\">
...
<script type=\"text/javascript\">
try {
var gwoTracker=_gat._getTracker(\"UA-331670-38\");
gwoTracker._trackPageview(\"/0614958473/goal\");
}catch(err){}</script>
<!-- End of Google Website Optimizer Conversion Script -->";
			
echo '<SCRIPT>
microsoft_adcenterconversion_domainid = 803087;
...
<NOSCRIPT><IMG width=1 height=1 SRC="http://803087.r.msn.com/?type=1&cp=1&dedup=1"/></NOSCRIPT><a href="http://advertising.microsoft.com/MSNadCenter/LearningCenter/adtracker.asp" target="_blank">&nbsp;</a>';

echo '<SCRIPT language="JavaScript" type="text/javascript">
<!-- Yahoo! Inc.
window.ysm_customData = new Object();
window.ysm_customData.conversion = "transId=,currency=,amount=";
var ysm_accountid  = "1VT9HSDPM28IRIKP8CGHM9A9BHO";
...
echo '<img src=http://cpa.directrdr.com/cpatrack?cid=57932&rev=0 width=1 height=1>';
...
<div style="margin:10px 0px;">
  ...
  <h7><span style="font-size:20px; color:#0381cc;">&#8250;</span> <span style="color:#f37901;font-size:16px; font-weight:bold;">Option  1</span>:  To receive immediate price information please <strong><a href="http://www.thermospas.com/pricing-information.html?tub=<?=$_REQUEST['tub']?>&amp;fname=<?=$_REQUEST['fname']?>&amp;lname=<?=$_REQUEST['lname']?>&amp;phone=<?=$_REQUEST['phone']?>&amp;email=<?=$_REQUEST['email']?>#call">click here</a> </strong>and select a time for a senior marketing representative  to call you.</h7> </div>
  <div style="margin:14px 30px;">
    ...
    <form action="dyo_ty.php" method="post">
      ...
      <table border="0" align="center" cellpadding="2" cellspacing="2" style="border: solid 1px #e2e3e4;">
        ...
        <tr>
          ...
          <td bgcolor="#ffffff"><? if ($_REQUEST['call'] == "err") { $cstyle = '"style="color: #990000;"'; } ?>
              <?
						  #
