...
<table border="0" cellspacing="5" cellpadding="5" width="930" height="330" id="dyo">
  <form action="http://www.thermospas.com/dyo.php" method="post">
    <tr>
      <td align="left" valign="top" width="200"><div><strong>Number of jets range</strong>:<br>
          <table border="0" cellspacing="2" cellpadding="2">
            <tr>
              ...
              <td><label for="jp" onClick="showdiv('tub1'),hidediv('tub2'),hidediv('tub3');"><strong>41-50</strong></label></td>
            </tr>
            <tr>
              <td><input name="jets" type="radio" value="g" onClick="showdiv('tub2'),hidediv('tub1'),hidediv('tub3');" id="jg"></td>
              <td><label for="jg" onClick="showdiv('tub2'),hidediv('tub1'),hidediv('tub3');"><strong>30-40</strong></label></td>
            </tr>
            <tr>
              <td><input name="jets" type="radio" value="s" onClick="showdiv('tub3'),hidediv('tub1'),hidediv('tub2');" id="js"></td>
              <td><label for="js" onClick="showdiv('tub3'),hidediv('tub1'),hidediv('tub2');"><strong>21-29</strong></label></td>
            </tr>
          </table>
        </div>
      ...
      <td align="left" valign="top" width="430"><div id="girl0"><img src="images/pixel.gif" alt="People in Hot Tub" width="400" height="221"></div>
        <div id="girl1"><img src="images/dyo/gemini/girls/1.png" alt="People in Hot Tub" width="400" height="221"></div>
        <div id="girl2"><img src="images/dyo/gemini/girls/2.png" alt="People in Hot Tub" width="400" height="221"></div>
        <div id="tub0"><img src="images/dyo/gemini_plat.jpg" alt="2-3 Person Hot Tub" width="400" height="221" id="jetstub"></div>
        <div id="tub1"><img src="images/dyo/gemini_plat.jpg" alt="2-3 Person Hot Tub" width="400" height="221" id="jetstub"></div>
        <div id="tub2"><img src="images/dyo/gemini_gold.jpg" alt="2-3 Person Hot Tub" width="400" height="221" id="jetstub"></div>
        <div id="tub3"><img src="images/dyo/gemini_silver.jpg" alt="2-3 Person Hot Tub" width="400" height="221" id="jetstub"></div>
        </td>
	...
	<input type="hidden" name="tub" value="23">
