<?php
/*
Template Name: Blog Grid Page Template
*/
?>
<?php 
  ...
  <div class="breadcrumb-wrapper"><div class="breadcrumb clearfix"><?php $helper->the_breadcrumb();?></div></div>
      <div class="content clearfix">
            ...
            <div class="posts-list clearfix posts-grid">
              ...
              <li class="author">By <?php the_author_posts_link() ?> on <?php echo get_the_date("j F Y"); ?> with <?php comments_number('No Comments', 'One Comment', '% Comments' );?> </li>
             </ul>
