...
$output .= '	<Contents>';
 ...
 foreach($slides as $slide) :
             ...
             $theImageSrc = $slide["src"];
				  ...
				  $imgurl = $theme_path."/timthumb.php?src=".urlencode($theImageSrc)."&h=371&w=980";       
...
//Settings
$output .= '<Settings ImageWidth="980" ImageHeight="371" LoaderColor="0x333333" InnerSideColor="0x222222" SideShadowAlpha="0.8" DropShadowAlpha="0" DropShadowDistance="0" DropShadowScale="0" DropShadowBlurX="40" DropShadowBlurY="4" MenuDistanceX="20" MenuDistanceY="15" MenuColor1="0x999999" MenuColor2="0x333333" MenuColor3="0xFFFFFF" ControlSize="100" ControlDistance="20" ControlColor1="0x222222" ControlColor2="0xFFFFFF" ControlAlpha="0.8" ControlAlphaOver="0.95" ControlsX="450" ControlsY="180" ControlsAlign="center" TooltipHeight="30" TooltipColor="0x222222" TooltipTextY="5" TooltipTextStyle="P-Italic" TooltipTextColor="0xFFFFFF" TooltipMarginLeft="5" TooltipMarginRight="7" TooltipTextSharpness="50" TooltipTextThickness="-100" InfoWidth="400" InfoBackground="0xFFFFFF" InfoBackgroundAlpha="0.95" InfoMargin="15" InfoSharpness="0" InfoThickness="0" Autoplay="'.$auto.'" FieldOfView="45"></Settings>';
