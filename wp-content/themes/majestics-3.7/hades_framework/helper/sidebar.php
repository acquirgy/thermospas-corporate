	  ...
	  if(isset($_POST["action"]))
	  {
		  $abars =  $_POST["active_sidebars"];
		   $inbars = $_POST["inactive_sidebars"];
	  	  ...
	  	  update_option("hades_active_sidebars", $abars);
		  update_option("hades_inactive_sidebars", $inbars);
	  }
	 
	  $active_sidebars = get_option("hades_active_sidebars");
	  $inactive_sidebars= get_option("hades_inactive_sidebars");
	   
	  if(!is_array($active_sidebars))
	  $active_sidebars = array();
	  
	   if(!is_array($inactive_sidebars))
