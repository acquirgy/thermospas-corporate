...
function event_register() {
	...
	$labels = array(
		'name' => _x('event', 'post type general name','h-framework'),
		'singular_name' => _x('Event', 'post type singular name','h-framework'),
		'add_new' => _x('Add New Event', 'event item','h-framework'),
		'add_new_item' => __('Add New Event Item','h-framework'),
