...
function createTestimonials()
{
	...
	$testi .= " <li> <p>".$slide["description"] ."</p> <a href='$slide[link]'> $slide[title] </a></li>";
	  }
	
	$tab = "<div class='testimonials-mega-wrapper'><div class='testimonials-wrapper'><h4 class='custom-font'>{$title}</h4><a href='#' class='scrollable-next' ></a> <a href='#' class='scrollable-prev' ></a> <div class='testimonials'><ul class='items'>".$testi ."</ul></div></div></div>";
