...
if($v_no>$theme_vo && get_option("hades_sticky_note")!="false" )
{
...
$theme_vo =(float)($theme_data['Version']); 
    ...
    <a href="#" class="sticky-note">Update Available</a>
...
?>
	...
	<input type="hidden" name="action" value="save" /><input type="hidden" name="verfication" id="verficiation" value="<?php echo md5(THEMENAME); ?>" />
...
function createHadesSelect($meta_value)
{
	?>
<div class="hades_input clearfix">
...
function createHadesSlider($meta_value)
{
	?>
<div class="hades_input clearfix">
  <label for="<?php echo $meta_value['id']; ?>"><?php _e( $meta_value['name'] , 'h-framework'); ?></label>
...
function createHadesToggle($meta_value)
{
	?>
  <div class="hades_input clearfix">
...
function createHadesTextbox($meta_value)
{
	?>
  <div class="hades_input clearfix">
      <label for="<?php echo $meta_value['id']; ?>"><?php _e( $meta_value['name'] , 'h-framework'); ?></label>
...
function createHadesTextarea($meta_value)
{
	?>
  <div class="hades_input clearfix">
									<label for="<?php echo $meta_value['id']; ?>"><?php _e( $meta_value['name'], 'h-framework'); ?></label>
...
function createHadesColorpicker($meta_value)
{
	?>
 	<div class="hades_input clearfix">
								<label for="<?php echo $meta_value['id']; ?>"><?php _e( $meta_value['name'], 'h-framework'); ?></label>
                <h6>#</h6><input type="text"  name="<?php echo $meta_value['id']; ?>" id="<?php echo $meta_value['id']; ?>" class="colorpickerField1 width-small" value="<?php if ( get_option( $meta_value['id'] ) != "") { echo stripslashes(get_option( $meta_value['id'])  ); } else { echo $meta_value['std']; } ?>" />
               <small class="cicon"></small> 
