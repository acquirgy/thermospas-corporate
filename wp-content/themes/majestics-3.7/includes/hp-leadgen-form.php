...
<script type="text/javascript" src="<?=get_bloginfo('template_directory');?>/js/process-fp-lead.js"></script>
	...
	<div class="leadgencontainer">
		...
		<div class="leadgen">
			...
			<form action="#" method="get" class="fp-lead-form" id="fp-lead-form">
				...
				<input name="address" class="clr" value="Address" type="text" />
				<input name="city" class="clr city" value="City" type="text" />
				<select name="state" class="clr state">
...
To watch videos, or to download your Free brochure or $1,000 coupon, <a href="/thermospas-dvd.html" style="text-decoration:underline;">click here</a>.<br /><br />
			...
			<div class="reasons-pdf">
				<a target="_blank" href="/100Reasons_105.pdf">Need 100 Reasons?</a>
			</div>
		</div>
	</div>
</div>
