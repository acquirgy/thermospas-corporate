...
<div class="clearfix page homepage container">
  ...
  <div class="showcase-section container">
      <div class="title"> <a href="#" class="sprev" style="top: 35px;"></a><a href="#" class="snext" style="top: 35px;"></a>
     	 <div style="text-align:center;"><img src="http://www.thermospas.com/slides/tagline1.png" /></div>
      </div>
    ...
    <div class="homepage-top-columns clearfix">
      ...
      <div class="title">
        <div style="text-align:center;"><img src="http://www.thermospas.com/slides/tagline1.png" /></div><? if (1==2) { ?><h4 class='custom-font' style="font-weight:bold">We Turn Water Into Therapy</h4><? } ?>
      </div>
      <?php endif; ?>
      <ul>
        <li>
	...
	<div class="title" style="margin:10px 0px">
      <div style="text-align:center;"><img src="http://www.thermospas.com/slides/tagline3.jpg" /></div><? if (1==2) { ?><h4 class='custom-font' style="font-weight:bold">ThermoSpas Hot Tub Videos</h4><? } ?>
    </div>
