...
$(".sticky-note").css("left", $(".hades-head").offset().left + $(".hades-head").width() - 35 );
$(".sticky-note").click(function(){  $( "#hades_opts" ).tabs("select",$("#themenav").children("li").length-1); });

$("#lightbox").prettyPhoto({ default_width:550, default_height:500 });
