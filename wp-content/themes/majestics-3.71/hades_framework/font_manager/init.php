...
function fontmanager_admin() {
	  ...
	  if(isset($_POST["action"]))
	  {
		  $arr_font = $_POST["font_name"];
	  	  update_option("hades_custom_fonts", $arr_font);
	  }
	  $custom_fonts = get_option("hades_custom_fonts");
	  if(!$custom_fonts)
	  $custom_fonts = array();
...
<div id="hades_opts" class="clearfix">
     <p class="info-text"><?php _e('To add a font first ','h-framework');?><a href="http://cufon.shoqolate.com/generate/">http://cufon.shoqolate.com/generate/</a> <?php _e(', convert the font into cufon javascript file and upload it here.','h-framework');?></p> 
