...
function gallery_register() {
	...
	$labels = array(
		'name' => _x('Gallery', 'post type general name','h-framework'),
		'singular_name' => _x('Gallery Page', 'post type singular name','h-framework'),
		'add_new' => _x('New Page', 'gallery item','h-framework'),
		'add_new_item' => __('Add New Gallery Page','h-framework'),
		'edit_item' => __('Edit Gallery Page','h-framework'),
		'new_item' => __('New Gallery Page','h-framework'),
		'view_item' => __('View Gallery Page','h-framework'),
		'search_items' => __('Search Galleries','h-framework'),
		'not_found' =>  __('Nothing found','h-framework'),
		'not_found_in_trash' => __('Nothing found in Trash','h-framework'),
		'parent_item_colon' => ''
	);
...
function gallery_columns_credits_meta() {
  ...
  $gallery_column = $custom["gallery_column"][0];
   $options = array("custom"=>"Gallery Style 1","custom1"=>"Gallery Proportional","flickr"=>"Flickr Gallery");
	?>
   ...
   <div class="slider-lists">
      ...
      <?php  foreach($slides as $slide) { ?>
         ...
         <div class="slide-body">
           ...
           <div class="separator clearfix">
                <label for=""><?php _e('Image Title:','h-framework');?></label>
                <input type="text" class="" name="title[]" value="<?php echo $slide['title'] ?>" />
           </div>
            <div class="lseparator clearfix">     
                <label for=""><?php _e('Description:','h-framework');?></label>
