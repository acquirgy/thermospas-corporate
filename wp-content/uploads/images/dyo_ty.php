...
if ($_REQUEST['call_day'] == 'choose' || $_REQUEST['call_time'] == 'choose') {
	...
	header ("Location: /pricing-information.html?tub=45&fname=Matt&lname=Bryers&zip=06416&city=Cromwell&phone=8607883880&email=mbryers@fightauthority.com&call=err#call");
...
mail($to, $subject, $message, $headers);
	...
	//header ("Location: /thermospas-dvd.html?callid=$callid");
